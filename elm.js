...
Elm.Index.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var modelPort = Elm.Native.Port.make(_elm).inbound("modelPort",
   "Maybe.Maybe Index.Model",
   function (v) {
      return v === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v === "object" && "currentFolder" in v && "folders" in v && "files" in v && "packages" in v ? {_: {}
                                                                                                                                                                                        ,currentFolder: typeof v.currentFolder === "string" || typeof v.currentFolder === "object" && v.currentFolder instanceof String ? v.currentFolder : _U.badPort("a string",
                                                                                                                                                                                        v.currentFolder)
                                                                                                                                                                                        ,folders: typeof v.folders === "object" && v.folders instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.folders.map(function (v) {
                                                                                                                                                                                           return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",
                                                                                                                                                                                           v);
                                                                                                                                                                                        })) : _U.badPort("an array",
                                                                                                                                                                                        v.folders)
                                                                                                                                                                                        ,files: typeof v.files === "object" && v.files instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.files.map(function (v) {
                                                                                                                                                                                           return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",
                                                                                                                                                                                           v);
                                                                                                                                                                                        })) : _U.badPort("an array",
                                                                                                                                                                                        v.files)
                                                                                                                                                                                        ,packages: typeof v.packages === "object" && v.packages instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.packages.map(function (v) {
                                                                                                                                                                                        ...
                                                                                                                                                                                        v.packages)} : _U.badPort("an object with fields \'currentFolder\', \'folders\', \'files\', \'packages\'",
      v));
   });
   var clearfix = A2($Html.div,
   _L.fromArray([$Html$Attributes.$class("clearfix")]),
   _L.fromArray([]));
   var pageHeader = function (_v0) {
      return function () {
         return A2($Html.header,
         _L.fromArray([]),
         _L.fromArray([A2($Html.div,
                      _L.fromArray([$Html$Attributes.$class("current-folder left")]),
                      _L.fromArray([$Html.text(_v0.currentFolder)]))
                      ,clearfix]));
      }();
   };
   var slash = F2(function (a,b) {
   ...
   var iconBox = F2(function (position,
   icon) {
      return A2($Html.span,
   ...
   var iconPath = "vendor/open-iconic-master/png";
   var basicIcon = function (name) {
      return A2($Html.img,
      _L.fromArray([$Html$Attributes.src(A2(slash,
                   iconPath,
                   name))
                   ,$Html$Attributes.width(12)
                   ,$Html$Attributes.height(12)]),
      _L.fromArray([]));
   };
   var fileIcon = basicIcon("file-4x.png");
   var fileDisplay = F2(function (basefolder,
   file) {
      return A2($Html.a,
      _L.fromArray([$Html$Attributes.$class("file element display")
                   ,$Html$Attributes.href(A2(slash,
                   basefolder,
                   file))]),
      _L.fromArray([A2(iconBox,
                   "left",
                   fileIcon)
                   ,$Html.text(file)]));
   });
   var folderIcon = basicIcon("folder-4x.png");
   var folderDisplay = F2(function (basefolder,
   folder) {
      return A2($Html.a,
      _L.fromArray([$Html$Attributes.$class("folder element display")
                   ,$Html$Attributes.href(A2(slash,
                   basefolder,
                   folder))]),
      _L.fromArray([A2(iconBox,
   ...
   var folderView = function (_v2) {
      return function () {
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("folder view left")]),
         A2($List._op["::"],
         A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("box-header display")]),
         _L.fromArray([$Html.text("Folder Contents")])),
         A2($Basics._op["++"],
         A2($List.map,
         folderDisplay(_v2.currentFolder),
         _v2.folders),
         A2($List.map,
         fileDisplay(_v2.currentFolder),
         _v2.files))));
      }();
   };
   var packageIcon = basicIcon("book-4x.png");
   var packageDisplay = function (_v4) {
      return function () {
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("package display element")]),
         _L.fromArray([A2(iconBox,
                      "left",
                      packageIcon)
                      ,$Html.text(_v4.name)]));
   ...
   var packagesView = function (packages) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("packages view right")]),
      A2($List._op["::"],
      A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("box-header display")]),
      _L.fromArray([$Html.text("Packages")])),
      A2($List.map,
      packageDisplay,
      packages)));
   };
   var view = function (model) {
      return function () {
         var view$ = function (model) {
            return A2($Html.div,
            _L.fromArray([]),
            _L.fromArray([pageHeader(model)
                         ,A2($Html.div,
                         _L.fromArray([$Html$Attributes.$class("centered page-wrapper")]),
                         _L.fromArray([folderView(model)
                                      ,packagesView(model.packages)]))]));
         };
         var modelMissing = A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("alert")]),
         _L.fromArray([$Html.text("no folder was found")]));
         return $Maybe.withDefault(modelMissing)($Maybe.map(view$)(model));
      }();
   };
   var main = $Signal.constant(view(modelPort));
